...
export unsigned short Entity::countEntity = 0;
...
Entity::Entity() : y(0), x(0), c(' '), nDirection(direction::NO_DIRECTION), speed(0) { countEntity++; }

Entity::Entity(const Entity& entity) : y(entity.y), x(entity.x), c(entity.c), nDirection(entity.nDirection),
speed(entity.speed) {
	countEntity++;
}
...
Entity::Entity(const short& _y, const short& _x) : y(_y), x(_x), c(' '), nDirection(direction::NO_DIRECTION),
speed(0) {
	countEntity++;
}

Entity::Entity(const short& _y, const short& _x, const char& _c) : y(_y), x(_x), c(_c),
nDirection(direction::NO_DIRECTION),
speed(0) {
	countEntity++;
}

Entity::Entity(const short& _y, const short& _x, const char& _c, const direction& _d) : y(_y), x(_x), c(_c),
nDirection(_d),
speed(0) {
	countEntity++;
}
